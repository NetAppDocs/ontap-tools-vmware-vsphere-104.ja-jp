...
VMware vSphere 7.0でNVMe/FCを使用する方法の詳細については、 https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html["ONTAP NVMe/FC ホスト構成ガイド"]および https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684"]を参照してください。
